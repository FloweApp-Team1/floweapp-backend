    ...
    : IRequestHandler<PlaceOrderCommand, Result<PlaceOrderResponse?>>
{
        ...
        PlaceOrderCommand request, Guid userId, OrderAddressDetails address, CheckoutPricingResult pricing)
    {
        var order = new Order
        {
            ...
            StorePhoneNumber = address.StorePhoneNumber,
            StoreWhatsAppNumber = address.StoreWhatsAppNumber,
            StoreImageUrl = address.StoreImageUrl,
            StoreAddressLine = address.StoreAddressLine,
            StoreLat = address.StoreLat,
            StoreLng = address.StoreLng,
