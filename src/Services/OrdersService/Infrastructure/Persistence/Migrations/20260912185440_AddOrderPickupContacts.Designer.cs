...
namespace OrdersService.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260912185440_AddOrderPickupContacts")]
    partial class AddOrderPickupContacts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OrdersService.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<string>("StoreAddressLine")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<string>("StoreWhatsAppNumber")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.HasIndex("Status", "DriverId", "CreatedAt");
